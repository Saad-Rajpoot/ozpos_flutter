...
class AppColors {
  ...
  static const orderTakeawayBgStart = Color(0xFFFED7AA); // orange-50 with 50% opacity
  static const orderTakeawayBgEnd = Color(0xFFFEF3C7); // amber-50 with 30% opacity
  
  static const orderDineInBorder = Color(0xFF86EFAC); // green-300
  static const orderDineInBgStart = Color(0xFFDCFCE7); // green-50 with 50% opacity
  static const orderDineInBgEnd = Color(0xFFD1FAE5); // emerald-50 with 30% opacity
  
  static const orderTableBorder = Color(0xFF93C5FD); // blue-300
  static const orderTableBgStart = Color(0xFFDBEAFE); // blue-50 with 50% opacity
  ...
  static const orderDeliveryBgStart = Color(0xFFEDE9FE); // purple-50 with 50% opacity
  static const orderDeliveryBgEnd = Color(0xFFFAF5FF); // fuchsia-50 with 30% opacity
...
class Breakpoints {
  ...
  static const double medium = 1280; // 901-1279dp: tablet landscape / small desktop
