...
class EnvironmentConfig {
  static const String _environment = String.fromEnvironment('ENVIRONMENT', defaultValue: 'debug');
  ...
  static const String sentryDsn = 'https://5043c056bceb3ca2e4a92d2e6e2b0235@o4509604948869120.ingest.us.sentry.io/4510112203341824';
  ...
  static Map<String, String> get firebaseConfig {
    switch (_environment) {
      case 'production':
        return {
          'project_id': 'ozpos-production',
          'environment': 'production',
        };
      case 'staging':
        return {
          'project_id': 'ozpos-staging', 
          'environment': 'staging',
        };
      default:
        return {
          'project_id': 'ozpos-development',
          'environment': 'debug',
        };
    }
  }
  ...
  static Duration get sessionTrackingInterval {
    if (isDebug) return const Duration(seconds: 10);     // Frequent tracking in debug
    if (isStaging) return const Duration(seconds: 30);   // Moderate tracking in staging  
