...
class OverrideAddonItemPriceEvent extends AddonManagementEvent {
  ...
  @override
  List<Object?> get props => [itemId, sizeId, categoryId, addonItemId, overridePrice];
}
...
class UpdateSelectionRulesEvent extends AddonManagementEvent {
  ...
  @override
  List<Object?> get props => [itemId, sizeId, categoryId, minSelection, maxSelection, isRequired];
}
