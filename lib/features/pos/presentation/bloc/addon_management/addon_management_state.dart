...
class AddonManagementLoaded extends AddonManagementState {
  ...
  final Map<String, List<ItemAddonAttachment>> itemAttachments; // itemId -> attachments
  final Map<String, Map<String, AddonRuleValidation>> validationResults; // itemId -> categoryId -> validation
  ...
  bool isCategoryAttached(String itemId, String? sizeId, String categoryId) {
    ...
    return attachments.any((a) => 
      a.sizeId == sizeId && 
      a.rules.any((r) => r.categoryId == categoryId)
    );
  }

  /// Get summary of all categories for picker
  List<AddonCategorySummary> getCategorySummaries(String itemId, String? sizeId) {
  ...
  @override
  List<Object?> get props => [categories, itemAttachments, validationResults, hasUnsavedChanges];
}
