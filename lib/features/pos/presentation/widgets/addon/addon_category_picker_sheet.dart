...
class AddonCategoryPickerSheet extends StatefulWidget {
  ...
  @override
  State<AddonCategoryPickerSheet> createState() => _AddonCategoryPickerSheetState();
...
class _AddonCategoryPickerSheetState extends State<AddonCategoryPickerSheet> {
  ...
  Widget _buildCategoryList() {
    return BlocBuilder<AddonManagementBloc, AddonManagementState>(
      builder: (context, state) {
        ...
        final summaries = state.getCategorySummaries(widget.itemId, widget.sizeId);
        final filteredSummaries = _searchQuery.isEmpty
            ? summaries
            : summaries.where((s) => s.name.toLowerCase().contains(_searchQuery)).toList();
          ...
          return Center(
            child: Column(
              ...
              children: [
                ...
                Text(
                  _searchQuery.isEmpty ? 'No add-on sets available' : 'No matching add-on sets',
  ...
  Widget _buildCategoryCard(BuildContext context, AddonCategory category, bool isAttached) {
    return Card(
          ...
          child: Row(
            children: [
              Container(
                ...
                height: 48,
                decoration: BoxDecoration(
                  color: isAttached ? Colors.blue.shade50 : Colors.grey.shade100,
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        Icon(Icons.fastfood, size: 14, color: Colors.grey.shade500),
