          ...
          children: [
            ...
            Row(
              children: [0, 5, 10, 15].map((percent) {
                final isSelected = state.tipPercent == percent && state.customTipAmount.isEmpty;
                return Expanded(
                  child: Padding(
                    padding: const EdgeInsets.symmetric(horizontal: 4),
                    child: OutlinedButton(
                      onPressed: () {
                        context.read<CheckoutBloc>().add(SelectTipPercent(percent: percent));
                      },
                      style: OutlinedButton.styleFrom(
                        backgroundColor: isSelected ? const Color(0xFF2196F3).withOpacity(0.08) : Colors.white,
                        ...
                        foregroundColor: isSelected ? const Color(0xFF2196F3) : Colors.black87,
                      ),
                      child: Text(
                        '$percent%',
                        style: TextStyle(
