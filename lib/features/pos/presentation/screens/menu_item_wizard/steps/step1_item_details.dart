...
class _Step1ItemDetailsState extends State<Step1ItemDetails> {
            ...
            child: Column(
              ...
              children: [
                ...
                _buildTextField(
                  ...
                  maxLines: 4,
                  onChanged: (value) {
                    context.read<MenuEditBloc>().add(UpdateItemDescription(value));
                  },
                ),
                const SizedBox(height: 24),
  ...
  Widget _buildInfoBanner(MenuEditState state) {
    ...
    final messages = hasErrors ? state.validation.errors : state.validation.warnings;
              ...
              children: messages.map((msg) {
                return Padding(
                  ...
                  child: Text(
                    ...
                    style: TextStyle(
                      fontSize: 14,
                      color: hasErrors ? Colors.red.shade900 : Colors.orange.shade900,
                    ),
                  ),
                );
              }).toList(),
                    ...
                    Positioned(
                      ...
                      child: Row(
                        children: [
                          ...
                          IconButton(
                            onPressed: () {
                              context.read<MenuEditBloc>().add(const RemoveImage());
                            },
  ...
  Widget _buildImageDisplay(MenuEditState state) {
    ...
    } else if (state.item.displayImagePath != null && state.item.displayImagePath!.isNotEmpty) {
                  ...
                  decoration: InputDecoration(
                    ...
                    border: OutlineInputBorder(
                      ...
                      borderSide: BorderSide(
                        color: state.validation.errors.any((e) => e.contains('price'))
                            ? Colors.red.shade300
                            : Colors.grey.shade300,
                      ),
                    ),
