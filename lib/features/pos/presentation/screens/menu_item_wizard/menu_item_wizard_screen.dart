...
import 'steps/step1_item_details.dart';
import 'steps/step2_sizes_addons.dart';
import 'steps/step3_upsells.dart';
import 'steps/step4_availability.dart';
      ...
      builder: (context, state) {
        return Scaffold(
          ...
          appBar: AppBar(
            ...
            elevation: 0,
            actions: [
              // Draft indicator (removed - not in state)
              if (false)
                Padding(
