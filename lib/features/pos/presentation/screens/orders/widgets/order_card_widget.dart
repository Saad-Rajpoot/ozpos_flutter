...
class OrderCardWidget extends StatelessWidget {
    ...
    return Row(
      children: [
        ...
        Container(
          ...
          child: Text(
            _getStatusLabel(),
            style: OrdersTokens.badge.copyWith(
  ...
  Widget _buildOrderInfo() {
    return Container(
      ...
      decoration: const BoxDecoration(
        border: Border(bottom: BorderSide(color: OrdersTokens.colorDivider, width: 2)),
      ),
      child: Column(
            ...
            children: [
              ...
              Container(
                ...
                child: Row(
                  ...
                  children: [
                    Icon(_getOrderTypeIcon(), size: 14, color: OrdersTokens.colorTextSecondary),
        ...
        children: [
          if (order.customerName.isNotEmpty)
            Container(
              ...
              child: Row(
                children: [
                  const Icon(Icons.person, size: 14, color: OrdersTokens.colorTextMuted),
              ...
              Expanded(
                child: Container(
                  ...
                  child: Row(
                    mainAxisSize: MainAxisSize.min,
                    children: [
                      const Icon(Icons.timer, size: 14, color: Color(0xFFD97706)),
                      const SizedBox(width: 4),
                      Text(
                        _getElapsedTime(),
                        style: OrdersTokens.bodySmall.copyWith(
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          Row(
            children: [
              const Icon(Icons.shopping_bag, size: 14, color: OrdersTokens.colorTextMuted),
              const SizedBox(width: 4),
              Text(
  ...
  List<Color> _getStatusGradient() {
    if (order.status == OrderStatus.cancelled) {
      return [OrdersTokens.colorStatusCancelledBg, OrdersTokens.colorStatusCancelledBg];
    }
    if (order.status == OrderStatus.completed) {
      return [OrdersTokens.colorStatusCompletedBg, OrdersTokens.colorStatusCompletedBg];
    }
    if (order.paymentStatus == PaymentStatus.unpaid) {
      return [OrdersTokens.colorStatusUnpaidBg, OrdersTokens.colorStatusUnpaidBg];
    }
