...
class AddonCategoryEditorDialog extends StatefulWidget {
  ...
  const AddonCategoryEditorDialog({
    Key? key,
    this.category,
  }) : super(key: key);
  ...
  @override
  State<AddonCategoryEditorDialog> createState() => _AddonCategoryEditorDialogState();
}
      ...
      child: Row(
        children: [
          ...
          Container(
            ...
            child: const Icon(Icons.drag_indicator, color: Colors.grey, size: 18),
          ),
          ...
          Expanded(
            ...
            child: TextField(
              ...
              decoration: InputDecoration(
                ...
                isDense: true,
                prefixIcon: Icon(Icons.fastfood, size: 18, color: Colors.green.shade600),
          ...
          SizedBox(
            ...
            child: TextField(
              ...
              decoration: InputDecoration(
                ...
                prefixText: '\$',
                prefixStyle: TextStyle(color: Colors.green.shade700, fontWeight: FontWeight.w600),
                isDense: true,
                contentPadding: const EdgeInsets.symmetric(horizontal: 12, vertical: 10),
              ),
