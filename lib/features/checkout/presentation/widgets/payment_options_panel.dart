...
class PaymentOptionsPanel extends StatelessWidget {
  ...
  Widget _buildPaymentMethods(BuildContext context, CheckoutLoaded state) {
    return Container(
      ...
      child: Column(
        ...
        children: [
          Text('Payment Method', style: CheckoutTokens.textTitle),
          const SizedBox(height: CheckoutTokens.gapNormal),
  ...
  Widget _buildMethodTile(
    ...
    final width =
        (CheckoutTokens.rightWidth -
            CheckoutTokens.cardPadding * 2 -
            CheckoutTokens.gapSmall) /
        2;
        ...
        child: Column(
          ...
          children: [
            Icon(
              ...
              size: 28,
              color: isSelected
                  ? CheckoutTokens.primary
                  : CheckoutTokens.textSecondary,
            ),
            ...
            Text(
              ...
              style: CheckoutTokens.textBody.copyWith(
                fontWeight: isSelected
                    ? CheckoutTokens.weightSemiBold
                    : CheckoutTokens.weightMedium,
                color: isSelected
                    ? CheckoutTokens.primary
