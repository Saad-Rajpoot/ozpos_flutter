...
Future<void> showEditPrinterDialog(BuildContext context, PrinterEntity printer) async {
  ...
  await showDialog(
    ...
    builder: (context) => StatefulBuilder(
      builder: (context, setState) {
        ...
        return AlertDialog(
          title: Row(
            children: const [Icon(Icons.edit_outlined), SizedBox(width: 8), Text('Edit Printer')],
          ),
          content: SizedBox(
            width: 700,
            child: Column(
            ...
            ElevatedButton(
              onPressed: () {
                if (step < 4) {
                  ...
                  Navigator.pop(context);
                  context.read<PrintingBloc>().add(UpdatePrinter(printer: updatedPrinter));
                }
              },
              child: Text(step < 4 ? 'Next' : 'Save Changes'),
            ),
          ],
        );
      },
