  ...
  static List<MenuItemModel> getMockMenuItems() {
    return [
      ...
      MenuItemModel(
        ...
        basePrice: 21.99,
        image:
            'https://via.placeholder.com/400x300/FF6B6B/FFFFFF?text=Pepperoni',
      ...
      MenuItemModel(
        ...
        basePrice: 20.99,
        image:
            'https://via.placeholder.com/400x300/FF6B6B/FFFFFF?text=Hawaiian',
        tags: [],
      ),
      ...
      MenuItemModel(
        ...
        basePrice: 16.99,
        image:
            'https://via.placeholder.com/400x300/FFE66D/FFFFFF?text=Carbonara',
        tags: ['Popular'],
      ),
      MenuItemModel(
        id: 'item-8',
      ...
      MenuItemModel(
        ...
        basePrice: 8.99,
        image:
            'https://via.placeholder.com/400x300/F38181/FFFFFF?text=Tiramisu',
        tags: ['Popular'],
      ),
      ...
      MenuItemModel(
        ...
        basePrice: 3.50,
        image:
            'https://via.placeholder.com/400x300/AA96DA/FFFFFF?text=Coca+Cola',
        tags: [],
      ),
      MenuItemModel(
        id: 'item-14',
